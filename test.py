...
# Invoervelden
auto = st.slider("Hoeveel km reis jij per jaar met uw auto?", min_value=0, max_value=50000, value=0, step=1)
trein = st.number_input("Hoeveel km reis jij per jaar met de trein?", min_value=0, value=None, step=1)
vliegtuig = st.number_input("Hoeveel km reis jij per jaar met het vliegtuig?", min_value=0, value=None, step=1)
